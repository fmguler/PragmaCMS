...
<html>
    <head>
        ...
        <title>Welcome to Pragma CMS</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="span2 offset1" style="margin-top:30px">
                    <img src="js/star.png">
                </div>
                <div class="span8">
                    ...
                    <h1 style="margin-bottom:18px">Hi! Let's Create an Account;</h1>
                    <form id="signupForm" method="post">
                        <table class="table style-full-width" style="inline">
                            <tr>
                                <td colspan="3">
                                    <h2>Account Info</h2>
                            ...
                            <tr>
                                <td colspan="3">
                                    <h2>Author Info</h2>
                                    <h6>The Primary Author. You can add other authors after signup.</h6>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><h6>This one is required :)</h6></td>
                            </tr>
                            <tr>
                                <td><strong>Password:</strong></td>
                                <td><input type="password" name="password"/></td>
                                <td><h6>Also this one...</h6></td>
                            </tr>
                            <tr>
